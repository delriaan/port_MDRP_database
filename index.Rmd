...
tags$table(
  ...
  , tags$tr(
      tags$th(style = "text-align:middle; border: solid 2px #AAAAFF; background-color:#EEEEEE; "
              , "CRAN", colspan = 3, width="70%")
      , tags$th(style = "text-align:middle; border: solid 2px #AAAAFF; background-color:#AAAAAA; word-wrap: break-word;"
                , width = "*"
                , HTML("GitHub<br><sub><code>remotes::install_github(</code><br><code>'delriaan/{package}', subdir = 'pkg')</code></sub>"))
      )
  , tags$tr(
      style = "align:top"
      , slider::slide(
