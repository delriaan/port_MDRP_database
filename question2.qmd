...
After generating the universe of events I explored the graphs using [`visNetwork`](https://visjs.github.io/vis-network/docs/network/). Only one graph was interesting enough to retain which can be viewed [here](./viznetwork_C0.html){target="_blank")}.
